...
@WebServlet("/app/reception/reservations")
public class ReceptionReservationsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("/WEB-INF/views/reception/reservations.jsp").forward(req, resp);
    }
}
